...
# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_frap/cityflow1x1/test/logger/2024_05_29-22_33_29_BRF.log
# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_myyfrap/cityflow1x1/test/logger/2024_07_14-16_01_41_BRF.log

# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_frap/cityflow1x1/test/logger/2024_06_24-13_43_05_BRF.log

file_path1 = 'data/output_data/tsc/cityflow_frap/cityflow1x1/test/logger/2024_06_24-13_43_05_BRF.log'
...
# 解析两个日志文件的数据
frap_data = parse_log_file(file_path1)
...
# 绘制Queue对比图
axs[0, 0].plot(frap_data.episode_list, frap_data.queue_list, label='frap')
...
# 绘制Delay对比图
axs[0, 1].plot(frap_data.episode_list, frap_data.delay_list, label='frap')
...
# 绘制Throughput对比图
axs[1, 0].plot(frap_data.episode_list, frap_data.throughput_list, label='frap')
...
axs[1, 1].plot(range(len(frap_data.travel_time_list)), frap_data.travel_time_list, label='frap_data')
