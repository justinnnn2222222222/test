...
# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_mplight/cityflow1x1_config1/real_delay/logger/2024_06_27-23_46_08_BRF.log
...
# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_frap/cityflow1x1_config1/real_delay/logger/2024_06_27-23_44_57_BRF.log
...
mplight_data = parse_log_file(file_path2)
frap_data = parse_log_file(file_path3)
myfrap_data = parse_log_file(file_path4)
...
# 保存图片到指定路径
output_path = os.path.join(output_dir, 'test7-four-method.png')
