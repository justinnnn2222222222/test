...
class NewModelAgent(RLAgent):
    ...
    def __init__(self, world, rank):
        ...
        print(f"self.ob_length:{self.ob_length}")
...
class NewModelNet(nn.Module):
    ...
    #     self.dense_1 = nn.Linear(input_dim, 16)
    #     self.dense_2 = nn.Linear(16, 20)
    ...
    def _forward(self, x):
        ...
        # print(f"After dense_1 shape: {x.shape}")
        x = F.relu(self.dense_2(x))
        # print(f"After dense_2 shape: {x.shape}")
        x = self.dense_3(x)
        return x
