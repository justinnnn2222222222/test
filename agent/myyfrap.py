...
@Registry.register_model('myyfrap')
class MYYFRAP_DQNAgent(RLAgent):
    '''
    ...
    def __init__(self, world, rank):
        ...
        self.reward_generator = LaneVehicleGenerator(self.world, self.inter_obj,
                                                     ["detailed_lane_pressure"], in_only=True, average="all",
                                                     negative=True)
    ...
    def _build_model(self):
        ...
        '''
        model = MYYFRAP(self.dic_agent_conf, self.num_actions, self.phase_pairs, self.comp_mask)
        return model
    ...
    def load_model(self, e):
        ...
        self.model = MYYFRAP(self.dic_agent_conf, self.dic_phase_expansion, self.num_actions, self.phase_pairs,
                          self.comp_mask)
        self.model.load_state_dict(torch.load(model_name))
        self.target_model = MYYFRAP(self.dic_agent_conf, self.dic_phase_expansion, self.num_actions, self.phase_pairs,
                                 self.comp_mask)
