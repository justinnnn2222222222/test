...
@Registry.register_model('myfrap')
class MYFRAP_DQNAgent(RLAgent):
    '''
    ...
    def __init__(self, world, rank):
        ...
        self.reward_generator = LaneVehicleGenerator(self.world, self.inter_obj,
                                                     ["pressure"], in_only=True, average="all",
                                                     negative=True)
    ...
    def _build_model(self):
        ...
        '''
        model = MYFRAP(self.dic_agent_conf, self.num_actions, self.phase_pairs, self.comp_mask)
        return model
    ...
    def load_model(self, e):
        ...
        self.model = MYFRAP(self.dic_agent_conf, self.dic_phase_expansion, self.num_actions, self.phase_pairs,
                          self.comp_mask)
        self.model.load_state_dict(torch.load(model_name))
        self.target_model = MYFRAP(self.dic_agent_conf, self.dic_phase_expansion, self.num_actions, self.phase_pairs,
                                 self.comp_mask)
