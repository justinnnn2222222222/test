...
# log文件如下
# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_dqn/cityflow1x6/test/logger/2024_10_25-02_23_18_BRF.log
# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_colight/cityflow1x6/test/logger/2024_10_25-09_25_51_BRF.log
# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_fixedtime/cityflow1x6/test/logger/2024_10_26-06_50_45_BRF.log
# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_myyfrap/cityflow1x6/test/logger/2024_10_25-16_03_52_BRF.log

# dqn,colight,fixedtime,myyfrap

# 指定宋体字体
font = FontProperties(fname="/home/panghu/rl_tsc/Libsignal/tnwsimsun.ttf", size=14)

file_path1 = 'data/output_data/tsc/cityflow_dqn/cityflow1x6/test/logger/2024_10_25-02_23_18_BRF.log'
file_path2 = 'data/output_data/tsc/cityflow_colight/cityflow1x6/test/logger/2024_10_25-09_25_51_BRF.log'
file_path3 = 'data/output_data/tsc/cityflow_fixedtime/cityflow1x6/test/logger/2024_10_26-06_50_45_BRF.log'
file_path4 = 'data/output_data/tsc/cityflow_myyfrap/cityflow1x6/test/logger/2024_10_25-16_03_52_BRF.log'
...
# dqn,colight,fixedtime,myyfrap
# 解析两个日志文件的数据
dqn_data = parse_log_file(file_path1)
colight_data = parse_log_file(file_path2)
fixedtime_data = parse_log_no_rl_file(file_path3)
myyfrap_data = parse_log_file(file_path4)
...
axs[0, 0].plot(myyfrap_data.episode_list, myyfrap_data.queue_list, label='myyfrap_data', linestyle='--',color='red', linewidth=2)
...
axs[0, 1].plot(myyfrap_data.episode_list, myyfrap_data.delay_list, label='myyfrap_data', linestyle='--',color='red', linewidth=2)
...
axs[1, 0].plot(myyfrap_data.episode_list, myyfrap_data.throughput_list, label='myyfrap_data', linestyle='--',color='red', linewidth=2)
...
axs[1, 1].plot(myyfrap_data.episode_list, myyfrap_data.travel_time_list, label='myyfrap_data', linestyle='--',color='red', linewidth=2)
...
# 保存图片到指定路径
output_path = os.path.join(output_dir, '1x6-4.png')
plt.savefig(output_path, dpi=300)
plt.show()
