...
# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_dqn/cityflow1x1/test/logger/2024_05_29-21_58_23_BRF.log
# /home/data/panghu/new/LibSignal/data/output_data/tsc/cityflow_mydqn/cityflow1x1/test/logger/2024_07_08-22_42_13_BRF.log

file_path1 = 'data/output_data/tsc/cityflow_mydqn/cityflow1x1/test/logger/2024_07_08-22_42_13_BRF.log'
...
print('frap_data')
# print(frap_data.episode_list)
# print(frap_data.travel_time_list)
print(frap_data.delay_list)
print(frap_data.queue_list)

# print('dqn_data')
# print(dqn_data.delay_list)
# print(dqn_data.queue_list)
...
axs[0, 0].plot(frap_data.episode_list, frap_data.queue_list, label='frap', linestyle='-.')
...
axs[0, 1].plot(frap_data.episode_list, frap_data.delay_list, label='frap', linestyle='-.')
...
axs[1, 0].plot(frap_data.episode_list, frap_data.throughput_list, label='frap', linestyle='-.')
...
axs[1, 1].plot(frap_data.episode_list, frap_data.queue_list, label='frap', linestyle='-.')
