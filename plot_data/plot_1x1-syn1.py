...
file_path3 = 'data/output_data/tsc/cityflow_myyfrap/cityflow1x1_syn1/test/logger/2024_07_25-14_12_51_BRF.log'
file_path4 = 'data/output_data/tsc/cityflow_mplight/cityflow1x1_syn1/test/logger/2024_07_25-14_13_53_BRF.log'
# no_rl
...
# 保存图片到指定路径
output_path = os.path.join(output_dir, '1x1-4-syn1.png')
plt.savefig(output_path, dpi=300)
plt.show()
